...
def lesen():
    os.system("raspistill -w 320 -h 240 -o /home/pi/images/image.jpg")
    ...
    zbarcam = subprocess.Popen("zbarimg --raw /home/kevin/images/image.jpg", stdout=subprocess.PIPE, shell=True,
